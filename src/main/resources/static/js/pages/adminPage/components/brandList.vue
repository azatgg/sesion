<template>
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex flex-column">
        ...
        <brand-form v-show="isModalVisible" @close="closeModal" :task="selectedTask" @updateTask="updateTask"/>
...
<script>
    import brandForm from 'pages/adminPage/components/brandForm.vue'
    export default {
        name: "brandList",
